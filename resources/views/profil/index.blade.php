            ...
            <div class="col-md-4">
                <div class="card card-secondary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                @if ($user->penilai->foto == null) src="{{ asset('assets/dist/img/blank.png') }}"
                    @else
                    src="{{ asset('/files' . '/' . $user->penilai->foto) }}" @endif
                                alt="User profile picture">
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item text-center">
                                <b>Pangkat, Gol. Ruang</b><br><span>{{ $user->penilai->pangkat->nama }}</span>
                            </li>
                            <li class="list-group-item text-center">
            ...
            <div class="col-md-4">
                <div class="card card-secondary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                @if ($user->atasan->foto == null) src="{{ asset('assets/dist/img/blank.png') }}"
                    @else
                    src="{{ asset('/files' . '/' . $user->atasan->foto) }}" @endif
                                alt="User profile picture">
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item text-center">
                                <b>Pangkat, Gol. Ruang</b><br><span>{{ $user->atasan->pangkat->nama }}</span>
                            </li>
                            <li class="list-group-item text-center">
            ...
            <div class="card card-secondary card-outline">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link {{ Request::is('profil') ? 'active' : '' }}"
                                href="#tab-ttd" data-toggle="tab">Ttd</a>
                        </li>
