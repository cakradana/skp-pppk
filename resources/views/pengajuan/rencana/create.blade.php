...
<div class="row">
    <div class="col">
                ...
                <div class="" style="padding: 20px 20px 20px;">
                    <form action="/pengajuan/rencana" method="POST" class="input_fields_wrap"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="target_kualitas" value="100" min="0"
        ...
        {{-- Modal Tambah Output --}}
        <div class="modal fade" id="tambah-output" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                        ...
                        <div class="" style="padding: 20px 20px 20px;">
                            <form action="/tambah-kegiatan" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input required type="number" step="0.01" min="0" max="10" class="form-control"
                                            id="ak" name="ak">
                                    </div>
                                </div>
                        </div>
