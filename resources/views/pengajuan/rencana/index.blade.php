...
<div class="row">
    <div class="col">
        ...
        <a href="#cetak" class="btn btn-warning mb-3 float-right disabled"><i class="fas fa-exclamation-triangle"></i>
                                ...
                                <td class="text-center">
                                    <form action="/pengajuan/rencana/{{ $rencana->kegiatan_id }}" method="POST"
                                        ...
                                        <button class="btn btn-sm btn-warning text-white reset-rencana-confirm" {{
                                            $atribut=='true' ? 'disabled' : '' }}><i class="fas fa-sync-alt"></i> Reset
                                            Rencana</button>
                                    </form>
                                </td>
                            </tr>
