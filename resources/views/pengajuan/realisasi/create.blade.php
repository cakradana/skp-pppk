    ...
    <div class="card card-primary card-outline">
        <div class="card-body table-responsive p-0">
            <div class="" style="padding: 20px 20px 20px;">
                <table id="" class="table table-striped table-bordered small" style="width:100%; font-size:70%">
                                    ...
                                    <div class="modal-body">
                                        <form action="/pengajuan/realisasi/{{ $rencana->id }}" method="POST"
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group mb-0">
                                                        ...
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">{{ $rencana->output->nama
                                                                }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <a href="#" onclick="myFunction('{{ $rencana->id }}')">Samakan
                                                        realisasi dengan
                                                        target</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group mb-1">
                                                        ...
                                                        <input type="number" class="form-control" min="0"
                                                            name="realisasi_biaya" max="" value=""
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <a class="text-info" href="" data-toggle="modal"
                                                        data-target="#dasar-pengajuan-nilai"><i class="fas fa-eye"></i>
                                                        Lihat Dasar
                                                        Pengajuan Nilai</a>
                                                </div>
                                            </div>
