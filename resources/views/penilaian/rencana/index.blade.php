                    ...
                    <table id="" class="table table-striped table-bordered small" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/penilaian/persetujuan/{{ $pengajuan->user->id }}" class="btn btn-sm btn-success mb-3 d-table-cell"><i class="fas fa-search"></i></a>
                                    <a href="/penilaian/persetujuan/setuju/{{ $pengajuan->user->id }}" class="mb-3 btn btn-sm d-table-cell {{ $pengajuan->status == 'disetujui' ? 'btn-secondary disabled' : 'btn-primary' }}"><i class="fas fa-check"></i></a>
                                </td>
                            </tr>
                            @endforeach
