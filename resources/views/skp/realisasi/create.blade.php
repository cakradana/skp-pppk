...
<div class="row">
    <div class="col">
        <div class="form-inline">
            ...
            <a href="#" class="btn btn-primary ml-1 mb-3"><i class="fas fa-search"></i> Proses</a>
            <button type="button" class="btn btn-success ml-auto p-2 mb-3" data-toggle="modal" data-target="#dasar-pengajuan-nilai"><i class="fas fa-eye"></i> Lihat Dasar Pengajuan Nilai</button>
        </div>
                    ...
                    <table id="" class="table table-striped table-bordered small" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $rencana->bulan }}</td>
                                <td class="text-center p-3">{{ $rencana->realisasi ? $rencana->realisasi->pengajuan_nilai : '-' }}</td>
                                <td class="text-center p-3">{{ $rencana->realisasi ? $rencana->realisasi->nilai_atasan : '-' }}</td>
                                <td>
                                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#isi-realisasi-{{ $rencana->id }}"><i class="fas fa-plus"></i></button>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/skp/realisasi" method="POST" enctype="multipart/form-data" class="form-inline">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-0">
                                                            <input type="number" class="form-control" disabled value="{{ $rencana->kuantitas }}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-1">
                                                            <input type="number" class="form-control" min="0" max="{{ $rencana->kuantitas }}" value="{{ $rencana->realisasi ? $rencana->realisasi->realisasi : "" }}">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">{{ $rencana->output }}</span>
                                                            </div>
                                                        </div>
                        ...
                        <table class="table table-bordered table-striped small">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Hasil kerja sempurna, tidak ada kesalahan, tidak ada revisi, dan pelayanan di atas standar yang ditentukan, dll.</td>
                                </tr>
                                <tr>
                                    <td class="text-center">76 - 90</td>
                                    <td>Hasil kerja mempunyai 1 atau 2 kesalahan kecil, tidak ada kesalahan besar, revisi, dan pelayanan sesuai standar yang ditentukan, dll.</td>
                                </tr>
                                <tr>
                                    <td class="text-center">61 - 75</td>
                                    <td>Hasil kerja mempunyai 3 atau 4 kesalahan kecil, tidak ada kesalahan besar, revisi, dan pelayanan cukup memenuhi standar yang ditentukan, dll.</td>
                                </tr>
                                <tr>
                                    <td class="text-center">51 - 60</td>
                                    <td>Hasil kerja mempunyai 5 kesalahan kecil, ada kesalahan besar, revisi, dan pelayanan tidak cukup memenuhi standar yang ditentukan, dll.</td>
                                </tr>
                                <tr>
                                    <td class="text-center">&lt; 50</td>
                                    <td>Hasil kerja mempunyai lebih dari 5 kesalahan kecil, ada kesalahan besar, kurang memuaskan, revisi, dan pelayanan di bawah standar yang ditentukan, dll.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
