...
body { margin-left: 0.7in; margin-right: 0.7in; margin-top: 0.75in; margin-bottom: 0.75in; }
    ...
    @endforeach
        ...
        <tr class="row15">
            ...
            <td class="column4 style11 s style11" colspan="7">tmpt, tgl bln thn</td>
        </tr>
        <tr class="row16">
        ...
        <tr class="row17">
            <td class="column0 style26 s style26" colspan="4">ttd_pjb</td>
            <td class="column4 style26 s style26" colspan="7">ttd_pgw</td>
        </tr>
        <tr class="row20">
            <td class="column0 style12 f style12" colspan="4">{{ $login->penilai->name }}</td>
            <td class="column4 style12 f style12" colspan="7">{{ $login->name }}</td>
        </tr>
        <tr class="row21">
            <td class="column0 style11 f style11" colspan="4">{{ $login->penilai->nip }}</td>
            <td class="column4 style27 f style27" colspan="7">{{ $login->nip }}</td>
        </tr>
        </tbody>
    </table>
