        ...
        <div class="card card-warning card-outline">
            ...
            <div class="card-body p-0">
                <div class="" style="padding: 20px 20px 20px;">
                    <form action="/master/jabatan/{{ $jabatan->id }}" method="POST" class="mb-5"
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-warning text-white text-white"><i class="fas fa-save"></i>
                    Simpan</button>
            </div>
            </form>
        </div>
