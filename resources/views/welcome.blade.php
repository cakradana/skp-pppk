...
<body class="d-flex h-100 text-center text-white" style="background-color: #343a40">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
            ...
            <p class="lead">Sasaran Kinerja Pegawai yang selanjutnya disingkat SKP adalah rencana kinerja dan target
                yang akan dicapai oleh PPPK yang harus dicapai setiap tahun.</p>
            <p class="lead">
                @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                <a href="{{ url('/dashboard') }}"
                    class="btn btn-lg btn-secondary fw-bold border-white bg-white">Dashboard</a>
                @else
        ...
        <footer class="mt-auto text-white-50">
            <p class="text-white"><strong>Copyright &copy; 2021 <a href="">R. Cakradana</a>.</strong> All rights
                reserved.</p>
        </footer>
    </div>
</body>
